...
void goStraight (char way, float cm) { // function with two entries and no return
  ...
  movement (way_, steps_);
}
//-------------------------------------------------------------------------------------------------------------------------//

// FUNCTION 3: TURN A CERTAIN ANGLE (IN DEGREES): -------------------------------------------------------------------------//
void turn (char way, float angle) { // function with two entries and no return
