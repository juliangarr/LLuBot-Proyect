  ...
  if(estacion){
    ...
    if(avanceLL > 0.0){
      ...
      if(verificarParking()){
        ...
        goStraight('R', 13.0);    // Girar 90 grados a la derecha

        // Devolver al control remoto
        actividadSel = 0;
        struct_emisor mensaje2;
        mensaje2.actividad = 0;
        mensaje2.dist_to_move = 0.0;
        enviar_datos(2, mensaje2);
        enviar_datos(3, mensaje2);
      }
    }
